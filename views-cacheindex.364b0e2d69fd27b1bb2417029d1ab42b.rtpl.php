...
<div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
                        ...
                        <div class="bxslider">
                            <div><img src="/res/site/img/h4-slide.png" title="iPhone"></div>
                            <div><img src="/res/site/img/h4-slide2.png" title="Also iPhone"></div>
                        </div>
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-carousel-price">
                                    <ins>R$<?php echo priceFormat($value1["vlprice"]); ?></ins> <!-- <del>$100.00</del> desconto -->
                                </div> 
                            </div>
                            <?php } ?>
                        </div>
